...
const { pricing: pricingCopy, useCasesSection: useCasesCopy } = siteCopy;

const companyShowcaseCopyItems = [
  siteCopy.companyShowcase.items.item1,
  siteCopy.companyShowcase.items.item2,
  siteCopy.companyShowcase.items.item3,
  siteCopy.companyShowcase.items.item4,
  siteCopy.companyShowcase.items.item5,
  siteCopy.companyShowcase.items.item6,
] as const;

const companyShowcaseItems = companyShowcaseCopyItems.map((item, index) => ({
  id: index + 1,
  name: item.name,
...
export const siteConfig = {
  ...
  getStartedUrl: siteCopy.links.app,
  url:
    process.env.NEXT_PUBLIC_APP_URL ||
    siteCopy.links.site ||
    "http://localhost:3000",
  keywords: [
    siteCopy.meta.keywords.keyword1,
    siteCopy.meta.keywords.keyword2,
    siteCopy.meta.keywords.keyword3,
    siteCopy.meta.keywords.keyword4,
  ],
  links: siteCopy.links,
  nav: {
    links: [
      { id: 1, name: siteCopy.nav.links.home, href: "#hero" },
      { id: 2, name: siteCopy.nav.links.howItWorks, href: "#bento" },
      { id: 3, name: siteCopy.nav.links.features, href: "#features" },
      { id: 4, name: siteCopy.nav.links.pricing, href: "#pricing" },
    ],
  },
  hero: {
    badgeIcon: (
    ...
    badge: siteCopy.hero.badge,
    title: siteCopy.hero.title,
    description: siteCopy.hero.description,
    cta: {
      primary: {
        text: siteCopy.hero.cta.primary,
        href: siteCopy.links.app,
      },
    },
    visual: {
      phrase: siteCopy.hero.visual.phrase,
      alt: siteCopy.hero.visual.alt,
    },
  },
  companyShowcase: {
    items: companyShowcaseItems,
  },
  featureSection: {
  ...
  bentoSection: {
    ...
    description: siteCopy.bentoSection.description,
    items: [
      {
        id: 1,
        content: <FirstBentoAnimation />,
        title: siteCopy.bentoSection.items.item1.title,
        description: siteCopy.bentoSection.items.item1.description,
      },
      {
        id: 2,
        content: <SecondBentoAnimation />,
        title: siteCopy.bentoSection.items.item2.title,
        description: siteCopy.bentoSection.items.item2.description,
      },
      {
        id: 3,
        content: (
        ...
        title: siteCopy.bentoSection.items.item3.title,
        description: siteCopy.bentoSection.items.item3.description,
      },
      {
        id: 4,
        content: <FourthBentoAnimation once={false} />,
        title: siteCopy.bentoSection.items.item4.title,
        description: siteCopy.bentoSection.items.item4.description,
      },
    ],
  },
  benefits: [
    {
      id: 1,
      text: siteCopy.benefits.benefit1,
      image: "/Device-6.png",
    },
    {
      id: 2,
      text: siteCopy.benefits.benefit2,
      image: "/Device-7.png",
    },
    {
      id: 3,
      text: siteCopy.benefits.benefit3,
      image: "/Device-8.png",
    },
    {
      id: 4,
      text: siteCopy.benefits.benefit4,
      image: "/Device-1.png",
    },
  ],
  growthSection: {
    title: siteCopy.growthSection.title,
    description: siteCopy.growthSection.description,
    items: [
      {
        id: 1,
        content: (
        ...
        title: siteCopy.growthSection.items.item1.title,
        description: siteCopy.growthSection.items.item1.description,
      },
      {
        id: 2,
        content: (
        ...
        title: siteCopy.growthSection.items.item2.title,
        description: siteCopy.growthSection.items.item2.description,
      },
    ],
  },
  quoteSection: siteCopy.quoteSection,
  pricing: {
    title: pricingCopy.title,
    description: pricingCopy.description,
    popularBadge: pricingCopy.popularBadge,
    periodSuffix: pricingCopy.periodSuffix,
    pricingItems: [
      {
        name: pricingCopy.tier.name,
        href: siteCopy.links.app,
        price: pricingCopy.tier.price,
        period: pricingCopy.tier.period,
        yearlyPrice: pricingCopy.tier.yearlyPrice,
        features: [
          pricingCopy.tier.features.feature1,
          pricingCopy.tier.features.feature2,
          pricingCopy.tier.features.feature3,
          pricingCopy.tier.features.feature4,
          pricingCopy.tier.features.feature5,
          pricingCopy.tier.features.feature6,
          pricingCopy.tier.features.feature7,
          pricingCopy.tier.features.feature8,
        ],
        description: pricingCopy.tier.description,
        buttonText: pricingCopy.tier.buttonText,
  ...
  useCasesSection: {
    ...
    items: useCasesCopy.items.map((item) => ({
      id: item.id,
      title: item.title,
      category: item.category,
      description: buildUseCaseDescription(item),
    })),
  },
  faqSection: {
    title: siteCopy.faqSection.title,
    description: siteCopy.faqSection.description,
    faQitems: siteCopy.faqSection.items.map((item, index) => ({
      id: index + 1,
  ...
  ctaSection: {
    id: "cta",
    title: siteCopy.ctaSection.title,
    backgroundImage: "/agent-cta-background.png",
    button: {
      text: siteCopy.brand.cta,
      href: siteCopy.links.app,
    },
    subtext: siteCopy.ctaSection.subtext,
  },
  brand: {
